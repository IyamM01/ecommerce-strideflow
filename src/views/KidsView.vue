...
<template>
  ...
  <main class="mx-auto w-full max-w-[1600px] flex-grow px-6 py-12 lg:px-12">
    <div class="mb-10">
      <h1 class="text-3xl font-bold text-black">Kids Collection</h1>
      <p class="mt-1 text-sm text-gray-400">Explore our curated collection for kids</p>
    </div>
    ...
    <div class="flex flex-col gap-12 md:flex-row">
      ...
      <div class="flex-grow flex flex-col gap-8">
        ...
        <ProductGrid gender="Kids" category="all" />
